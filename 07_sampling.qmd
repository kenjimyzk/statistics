...
Pythonでパラレルワールドをシミュレーションしてみましょう。
...
g = sns.FacetGrid(results, col="size", col_order=[f"n={n}" for n in sample_sizes], sharey=False)
...
# 理論上のSE（母分散が 1/12 の一様分布 U(0,1) から、n=30 の平均）
